...
class CYoshi_Stage;
class COneWayFloor : public CGameObject
{
public:
...
public:
	explicit COneWayFloor(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit COneWayFloor(const COneWayFloor& rhs);
	virtual ~COneWayFloor() = default;
...
private:
	...
	CMesh_Static*		m_pCollisionMeshCom = nullptr;
