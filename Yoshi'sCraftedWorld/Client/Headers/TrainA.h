...
class CSteamTrain;
class CYoshi_Stage;
class CTrainA final : public CGameObject
{
private:
	explicit CTrainA(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CTrainA(const CTrainA& rhs);
	virtual ~CTrainA() = default;
...
public:
	...
	CTransform* Get_TrainTransform() { return m_pTransformCom; }
