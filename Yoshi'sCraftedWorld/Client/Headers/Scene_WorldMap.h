...
class CScene_WorldMap : public CScene
{
public:
	explicit CScene_WorldMap(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CScene_WorldMap() = default;
...
public:
	static CScene_WorldMap* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual void Free();
};
