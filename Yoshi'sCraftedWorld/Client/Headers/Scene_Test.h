...
{
private:
	explicit CScene_Test(LPDIRECT3DDEVICE9 pGraphic_Device);
...
private:
	...
	HRESULT Ready_Layer_Unit(const _tchar* pLayerTag);

public:
	HRESULT Add_StaticObjectFromFile(const _tchar* pFilePath, const _tchar* pLayerTag);

public:
	static CScene_Test* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual void Free();
};
