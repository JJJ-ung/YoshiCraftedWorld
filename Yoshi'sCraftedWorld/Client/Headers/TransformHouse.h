...
BEGIN(Client)
class CYoshi_Stage;
class CTransformHouse final : public CGameObject
{
private:
	explicit CTransformHouse(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CTransformHouse(const CTransformHouse& rhs);
	virtual ~CTransformHouse() = default;
