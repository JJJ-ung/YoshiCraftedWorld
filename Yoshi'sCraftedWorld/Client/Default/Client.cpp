                     ...
                     _In_ int       nCmdShow)
{
	...
	// 기본 메시지 루프입니다.
	_double Timer_Acc = 0.0;
	_double Limit_60 = 1.0 / 60.0;
	_double Limit_100 = 1.0 / 100.0;
	...
	while (true)
	{
		...
		Timer_Acc += pTimer_Manager->Compute_Timer(L"Timer_Default");

		if (nullptr == pMainApp)
			break;

		if (Limit_100 < Timer_Acc)
		{
			Timer_Acc = 0.0;

			if (pMainApp->Update_MainApp(pTimer_Manager->Compute_Timer(L"Timer_100")) & 0x80000000)
				break;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, L"Yoshi's Crafted World", WS_OVERLAPPEDWINDOW,
