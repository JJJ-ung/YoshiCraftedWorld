...
HRESULT Engine::CGraphic_Device::Ready_GraphicDev(HWND hWnd, 
											WINMODE eMode, 
											const _uint& iSizeX, 
											const _uint& iSizeY, 
...
void Engine::CGraphic_Device::Render_Begin(D3DXCOLOR Color)
{
...
void Engine::CGraphic_Device::Render_End(void)
{
